...
namespace GestioneOrdini
{
    public static class Barcode
    {
        ...
        {
            get { return Barcode.hasCheckSum; }
            set { Barcode.hasCheckSum = value; }
        }

        public static char GroutSeperator
        {
            get { return Barcode.groutSeperator; }
            set { Barcode.groutSeperator = value; }
        }

        public static string EAN128StartCode
        {
            get { return Barcode.ean128StartCode; }
            set { Barcode.ean128StartCode = value; }
        }

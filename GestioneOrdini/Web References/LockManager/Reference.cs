...
namespace GestioneOrdini.LockManager {
    ...
    public partial class MicroareaLockManager : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback LockReadWriteRecordOperationCompleted;
        ...
        public MicroareaLockManager() {
            this.Url = global::GestioneOrdini.Properties.Settings.Default.GestioneOrdini_LockManager_MicroareaLockManager;
        ...
        /// <remarks/>
        public event LockReadWriteRecordCompletedEventHandler LockReadWriteRecordCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://microarea.it/LockManager/LockReadWriteRecord", RequestNamespace="http://microarea.it/LockManager/", ResponseNamespace="http://microarea.it/LockManager/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public bool LockReadWriteRecord(string companyDBName, string authenticationToken, string userName, string tableName, string processName, string address, string lockKey, bool writeLock, out string[] users, out string[] addresses) {
            object[] results = this.Invoke("LockReadWriteRecord", new object[] {
                        companyDBName,
                        authenticationToken,
                        userName,
                        tableName,
            ...
            addresses = ((string[])(results[2]));
            return ((bool)(results[0]));
        }
        
        /// <remarks/>
        public void LockReadWriteRecordAsync(string companyDBName, string authenticationToken, string userName, string tableName, string processName, string address, string lockKey, bool writeLock) {
            this.LockReadWriteRecordAsync(companyDBName, authenticationToken, userName, tableName, processName, address, lockKey, writeLock, null);
        }
        
        /// <remarks/>
        public void LockReadWriteRecordAsync(string companyDBName, string authenticationToken, string userName, string tableName, string processName, string address, string lockKey, bool writeLock, object userState) {
            if ((this.LockReadWriteRecordOperationCompleted == null)) {
                this.LockReadWriteRecordOperationCompleted = new System.Threading.SendOrPostCallback(this.OnLockReadWriteRecordOperationCompleted);
            }
            this.InvokeAsync("LockReadWriteRecord", new object[] {
                        companyDBName,
                        authenticationToken,
                        userName,
                        tableName,
                        ...
                        address,
                        lockKey,
                        writeLock}, this.LockReadWriteRecordOperationCompleted, userState);
        }
        
        private void OnLockReadWriteRecordOperationCompleted(object arg) {
            if ((this.LockReadWriteRecordCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.LockReadWriteRecordCompleted(this, new LockReadWriteRecordCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void LockReadWriteRecordCompletedEventHandler(object sender, LockReadWriteRecordCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class LockReadWriteRecordCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal LockReadWriteRecordCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
